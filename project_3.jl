...
using SymbolicRegression, Distributed, CSV, DataFrames, MultivariateStats, Statistics, Plots

# ╔═╡ d9b712ff-fa4f-4590-b619-1554bd46f38c
path = "C:/Users/jaspe/OneDrive/Bureaublad/Documenten/School/2021-2022_Master_Bioinformatics_2/Semester 1/STMO/project_3/moodsData.csv"

# ╔═╡ 4ec5675e-a40b-4f12-bffc-9c6aeeebf7c0
dataset = DataFrame(CSV.File(path; header=1, delim=";"))

# ╔═╡ ca4cc713-4bfd-4a15-82d3-29553ffe89aa
X = Matrix(Matrix{Float64}(dataset[:,vcat(2,4:6,8:9)])')
...
[[SymbolicRegression]]
deps = ["Distributed", "FromFile", "JSON3", "LineSearches", "LossFunctions", "Optim", "Pkg", "Printf", "Random", "Reexport", "SpecialFunctions", "SymbolicUtils"]
git-tree-sha1 = "2765a3fc444843dfcb50b41b7d1d9f9f65af5c70"
